<table class="table table-striped">
	<tr>
		...
		<td>
			<?php echo $this->Session->read('Dossier.PersonneNom') . " " . $this->Session->read('Dossier.PersonnePrenom'); ?>
		</td>
		<td>
	...
	<tr>
		<th>Elève</th>
		<td>
			<?php echo $this->Session->read('Dossier.EleveNom') . " " . $this->Session->read('Dossier.ElevePrenom'); ?>
		</td>
		<td>
	...
	<tr>
		<th>Exercice</th>
		<td><?php echo $this->Session->read('Dossier.Exercice'); ?></td>
		<td></td>
	</tr>
	<tr>
		<th>Opération</th>
