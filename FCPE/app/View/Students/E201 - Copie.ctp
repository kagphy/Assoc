	...
	<div class="col-md-6 col-md-offset-3">
		...
		<?php 
			...
			echo $this->Form->input('classe', array(
				...
				'class'=>'form-control',
				'options'=>$setClasse,
				'onchange'=>" $.get( '" . $this->Html->url( array( 'controller' => 'students', 'action' => 'ajaxE201' ), true ) . "/'+$( '#classe' ).val(),
                        function( data ) {
			...
			echo $this->Form->input('lv1', array(
				...
				'class'=>'form-control',
				'options'=>array(''),
				'onchange'=>" $.get( '" . $this->Html->url( array( 'controller' => 'students', 'action' => 'ajaxE201b' ), true ) . "/'+$( '#classe' ).val()+'/LV2',
                        function( data ) {
                            var obj = jQuery.parseJSON( data );
			...
			echo $this->Form->input('lv2', array(
				...
				'class'=>'form-control',
				'options'=>'',
				'onchange'=>" $.get( '" . $this->Html->url( array( 'controller' => 'students', 'action' => 'ajaxE201b' ), true ) . "/'+$( '#classe' ).val()+'/LV3',
                        function( data ) {
                            var obj = jQuery.parseJSON( data );
