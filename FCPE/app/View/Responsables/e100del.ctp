<div class="row">
	...
	<div class="col-md-5">
		...
		<?php
		    ...
		    'class' => 'form-control',
		    'options' => array('Personnel', 'Personnel & Association' , 'Personnel & Association & Tutelles' ),
		    'empty' =>  $perso['NiveauDInformationNom'],
		    'label' => array(
		        'class' => 'control-label',
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        voulez vous réellement procéder à la destruction du dossier de <?php echo $perso['PersonnePrenom']; echo $perso['PersonneNom']; ?>
      </div>
      <div class="modal-footer">
      	<a href="<?php echo $this->Html->url(array('controller'=>'Responsables', 'action'=>'deletePerso')); ?>" class="btn btn-primary" role="button">Confirmer</a>
      	<a href="<?php echo $this->Html->url(array('controller'=>'Responsables', 'action'=>'e100')); ?>" class="btn btn-primary" role="button">Annuler</a>     
      </div>
    </div>
  </div>
</div>