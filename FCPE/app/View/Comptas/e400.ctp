<table class="table table-striped">
	...
	<tr>
		<th>Personne</th>
		<td><?php echo $_SESSION['Dossier']['PersonneNom'] . " " . $_SESSION['Dossier']['PersonnePrenom'];?></td>
		<td></td>
		<td></td>
	</tr>
	<tr>
...
<table class="table table-striped">
	...
	<tr>
		...
		<td>
			<input type="text" id="DateOperation<?php echo $i; ?>" class="form-control">
		</td>
		<td>
			<input type="text" id="DateDepot<?php echo $i; ?>" class="form-control" disabled>
		</td>
		<td>
			<input type="text" id="DateValeur<?php echo $i; ?>" class="form-control" disabled>
		</td>
		<td>
			<?php
